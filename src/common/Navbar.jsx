        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="md:flex md:items-center md:gap-12">
            ...
            <div className="flex items-center gap-4">
              <Link to="/cart" className="relative text-gray-600 hover:text-black-500">
              ...
              {isAuthenticated ? (
                ...
                <div className="hidden md:flex md:gap-4">
                  <Link
  className="rounded-md bg-gray-100 px-5 py-2.5 text-sm font-medium text-black transition hover:text-gray-700"
  to="/login"
>
  Login
</Link>
                  <Link
  className="rounded-md bg-gray-600 px-5 py-2.5 text-sm font-medium text-white transition hover:bg-black"
  to="/register"
>
  Register
</Link>
